           ...
           /*        $(".page-link").click(function(){
                ...
                function  viewBoardTable(page2,selectoption2,searchtext2){
                	...
                	var listSize2 = document.getElementById("listchange").value;
                $.ajax({
				...
				function viewBoardTable2(page2,selectoption2,searchtext2){
            	   ...
            	   $.ajax({
            		   ...
            		   var paging =  "<div class='container' style='padding-left: 23px; padding-right: 23px;'>";
            		       ...
            		       paging += "					</li>";
            		       paging += "					<input type='hidden' value='"+data.selectoption+"' id='hiseop'>";
            		       paging += "					<input type='hidden' value='"+data.searchtext+"' id='hisete'>";
				...
				//검색된값 + 화면에 보일 갯수 선택
				$(function(){
					$('#listchange').change(function(){
						var aa = $("#hiseop").val();
						var bb = $("#hisete").val();
						var cc = 1;
						viewBoardTable(cc, aa, bb);
					});
				});
